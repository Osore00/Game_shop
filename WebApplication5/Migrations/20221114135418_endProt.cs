...
{
    public partial class endProt : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Date_of_public = table.Column<string>(type: "nvarchar(max)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Purshes", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Purshes_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PurshesId = table.Column<int>(type: "int", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_GameKeys_Purshes_PurshesId",
                        column: x => x.PurshesId,
                        principalTable: "Purshes",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_GameKeys_PurshesId",
                table: "GameKeys",
                column: "PurshesId");

            migrationBuilder.CreateIndex(
                name: "IX_Purshes_UserId",
                table: "Purshes",
                column: "UserId");
        }
